export const CONFIG = {
  ...
  authorWebsite: 'https://stoloshxweli.org', // Put a link to your website or social media here
  ...
  startDate: 'February 22, 2022 00:00:00', // what date and time to start your game from
